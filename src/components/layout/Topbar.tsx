...
const Topbar: React.FC<TopbarProps> = ({ title, onMenuClick }) => {
  return (
    <header className="bg-white/70 backdrop-blur-lg border-b border-slate-200 fixed top-0 right-0 left-0 lg:left-64 z-30 transition-all duration-300 pt-[env(safe-area-inset-top)]">
